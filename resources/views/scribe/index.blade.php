...
<head>
    ...
    <title>ApirestBibliotheque API Documentation</title>
...
Ce endpoint permet à un utilisateur de se connecter.</a>
                            </li>
...
Ce endpoint permet à un utilisateur authentifié de se déconnecter (invalider le token).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-GETapi-email-verify--id---hash-">
                                <a href="#authentification-GETapi-email-verify--id---hash-">Vérification de l’e-mail

Ce endpoint valide l’e-mail de l’utilisateur via un lien.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-POSTapi-email-verification-notification">
                                <a href="#authentification-POSTapi-email-verification-notification">Renvoyer le lien de vérification

Ce endpoint renvoie un e-mail de vérification à l’utilisateur connecté.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-POSTapi-forgot-password">
                                <a href="#authentification-POSTapi-forgot-password">Demande de réinitialisation du mot de passe

Envoie un lien de réinitialisation du mot de passe à l’e-mail fourni.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-POSTapi-reset-password">
                                <a href="#authentification-POSTapi-reset-password">Réinitialiser le mot de passe

Réinitialise le mot de passe via le token reçu par e-mail.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-roles--id-">Affiche un rôle spécifique via son slug.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-roles--id-">
                                <a href="#endpoints-PUTapi-roles--id-">Met à jour un rôle existant.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-roles--id-">Supprime un rôle.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-livres">
                                <a href="#endpoints-GETapi-livres">GET api/livres</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-livres--slug-">
                                <a href="#endpoints-GETapi-livres--slug-">GET api/livres/{slug}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-livres-store">
                                <a href="#endpoints-POSTapi-livres-store">POST api/livres/store</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-livres--slug-">
                                <a href="#endpoints-PUTapi-livres--slug-">PUT api/livres/{slug}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-livres--slug-">
                                <a href="#endpoints-DELETEapi-livres--slug-">DELETE api/livres/{slug}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-recherche-livre">
                                <a href="#endpoints-GETapi-recherche-livre">GET api/recherche/livre</a>
                            </li>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Inscription r&eacute;ussie, v&eacute;rifiez votre e-mail.&quot;,
    &quot;user&quot;: {
        &quot;id&quot;: 1,
        &quot;name&quot;: &quot;Jean Dupont&quot;,
...
Ce endpoint permet à un utilisateur de se connecter.</h2>
...
Ce endpoint permet à un utilisateur authentifié de se déconnecter (invalider le token).</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentification-GETapi-email-verify--id---hash-">Vérification de l’e-mail

Ce endpoint valide l’e-mail de l’utilisateur via un lien.</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/email/verify/17/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/email/verify/17/consequatur"
);
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Email v&eacute;rifi&eacute; avec succ&egrave;s&quot;
}</code>
 </pre>
    </span>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID de l’utilisateur. Exemple: 1 Example: <code>17</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>Hash de vérification. Exemple: abcd1234 Example: <code>consequatur</code></p>
            </div>
                    </form>

                    <h2 id="authentification-POSTapi-email-verification-notification">Renvoyer le lien de vérification

Ce endpoint renvoie un e-mail de vérification à l’utilisateur connecté.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Lien de v&eacute;rification renvoy&eacute;&quot;
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentification-POSTapi-forgot-password">Demande de réinitialisation du mot de passe

Envoie un lien de réinitialisation du mot de passe à l’e-mail fourni.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email de l’utilisateur. Exemple: jean@example.com Example: <code>qkunze@example.com</code></p>
        </div>
        </form>

                    <h2 id="authentification-POSTapi-reset-password">Réinitialiser le mot de passe

Réinitialise le mot de passe via le token reçu par e-mail.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le token de réinitialisation. Exemple: abc123 Example: <code>consequatur</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nouveau mot de passe. Exemple: newpass456 Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password_confirmation</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Confirmation. Exemple: newpass456 Example: <code>consequatur</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="nom"                data-endpoint="POSTapi-categories"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Le texte de value ne peut pas contenir plus de 255 caractères. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
        </div>
        </form>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="nom"                data-endpoint="PUTapi-categories--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Le texte de value ne peut pas contenir plus de 255 caractères. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-roles--id-">Affiche un rôle spécifique via son slug.</h2>
...
<p>The ID of the role. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-roles--id-">Met à jour un rôle existant.</h2>
...
<p>The ID of the role. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-livres">GET api/livres</h2>
...
<span id="example-requests-GETapi-livres">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/livres" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<code class="language-json" style="max-height: 300px;">[
    {
        ...
        &quot;user&quot;: {
            ...
            &quot;updated_at&quot;: &quot;2025-08-04T02:07:19.000000Z&quot;
        }
    }
]</code>
 </pre>
...
<span id="execution-results-GETapi-livres" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-livres"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-livres"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-livres" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-livres">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-livres" data-method="GET"
      data-path="api/livres"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-livres"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-livres"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-livres--slug-">GET api/livres/{slug}</h2>
...
<span id="example-requests-GETapi-livres--slug-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/livres/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/livres/consequatur"
);
...
<span id="execution-results-GETapi-livres--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-livres--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-livres--slug-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-livres--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-livres--slug-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-livres--slug-" data-method="GET"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-livres--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-livres--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="GETapi-livres--slug-"
               value="consequatur"
               data-component="url">
    <br>
<p>The slug of the livre. Example: <code>consequatur</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-POSTapi-livres-store">POST api/livres/store</h2>
...
<span id="example-requests-POSTapi-livres-store">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/livres/store" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"titre\": \"vmqeopfuudtdsufvyvddq\",
    \"description\": \"Dolores dolorum amet iste laborum eius est dolor.\",
    \"date_sortie\": \"2025-08-04T23:36:53\",
...
<span id="example-responses-POSTapi-livres-store">
</span>
<span id="execution-results-POSTapi-livres-store" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-livres-store"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-livres-store"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-livres-store" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-livres-store">
...
<form id="form-POSTapi-livres-store" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/livres/store</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-livres-store"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="titre"                data-endpoint="POSTapi-livres-store"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Le texte de value ne peut pas contenir plus de 255 caractères. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-livres-store"
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>date_sortie</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date_sortie"                data-endpoint="POSTapi-livres-store"
               value="2025-08-04T23:36:53"
               data-component="body">
    <br>
<p>Le champ value n'est pas une date valide. Example: <code>2025-08-04T23:36:53</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="categorie_id"                data-endpoint="POSTapi-livres-store"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-livres--slug-">PUT api/livres/{slug}</h2>
...
<span id="example-requests-PUTapi-livres--slug-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-livres--slug-">
</span>
<span id="execution-results-PUTapi-livres--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-livres--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-livres--slug-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-livres--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-livres--slug-">
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-livres--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="PUTapi-livres--slug-"
               value="consequatur"
               data-component="url">
    <br>
<p>The slug of the livre. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="titre"                data-endpoint="PUTapi-livres--slug-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Le texte de value ne peut pas contenir plus de 255 caractères. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-livres--slug-"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="categorie_id"                data-endpoint="PUTapi-livres--slug-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the categories table.</p>
                    ...
                    <h2 id="endpoints-DELETEapi-livres--slug-">DELETE api/livres/{slug}</h2>
...
<span id="example-requests-DELETEapi-livres--slug-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-livres--slug-">
</span>
<span id="execution-results-DELETEapi-livres--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-livres--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-livres--slug-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-livres--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-livres--slug-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-livres--slug-" data-method="DELETE"
      data-path="api/livres/{slug}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-livres--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-livres--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="DELETEapi-livres--slug-"
               value="consequatur"
               data-component="url">
    <br>
<p>The slug of the livre. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-recherche-livre">GET api/recherche/livre</h2>
...
<span id="example-requests-GETapi-recherche-livre">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/recherche/livre" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/recherche/livre"
);
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;first_page_url&quot;: &quot;http://localhost/api/recherche/livre?page=1&quot;,
    &quot;from&quot;: 1,
    &quot;last_page&quot;: 1,
    &quot;last_page_url&quot;: &quot;http://localhost/api/recherche/livre?page=1&quot;,
    &quot;links&quot;: [
        {
            &quot;url&quot;: null,
        ...
        {
            &quot;url&quot;: &quot;http://localhost/api/recherche/livre?page=1&quot;,
            &quot;label&quot;: &quot;1&quot;,
            &quot;active&quot;: true
        },
        {
    ...
    &quot;next_page_url&quot;: null,
    &quot;path&quot;: &quot;http://localhost/api/recherche/livre&quot;,
    &quot;per_page&quot;: 10,
    &quot;prev_page_url&quot;: null,
    &quot;to&quot;: 1,
    &quot;total&quot;: 1
...
<span id="execution-results-GETapi-recherche-livre" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-recherche-livre"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-recherche-livre"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-recherche-livre" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-recherche-livre">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-recherche-livre" data-method="GET"
      data-path="api/recherche/livre"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/recherche/livre</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-recherche-livre"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-recherche-livre"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
